    ...
    return (
        <div className={cn("transition-all duration-300", className)}>
            <Menu setActive={setActive}>
                ...
                <MenuItem data-aos="fade-right" data-aos-duration="500" data-aos-delay="1500" className=" text-[18px]" href="#news" setActive={setActive} active={active} item="ข่าวสาร">
                    <div className=" absolute top-0 left-0 w-full h-full bg-gradient-to-b from-blue-400 to-green-600 opacity-15 blur z-10" />
        ...
        <div className={cn("transition-all duration-300 h-screen backdrop-blur-sm bg-white/75 dark:bg-black/75 top-0 left-0 right-0", className)}>
            <Menu setActive={setActive}>
                <div className="flex flex-col gap-4">
                    <MenuItem onClick={() => setMobileMenuOpen(false)} data-aos="fade-right" data-aos-duration="500" data-aos-delay="0" className=" text-[18px]" href="#home" setActive={setActive} active={active} item="หน้าหลัก" />
                    <MenuItem onClick={() => setMobileMenuOpen(false)} data-aos="fade-right" data-aos-duration="500" data-aos-delay="0" className=" text-[18px]" href="#news" setActive={setActive} active={active} item="ข่าวสาร" />
                    <MenuItem onClick={() => setMobileMenuOpen(false)} data-aos="fade-right" data-aos-duration="500" data-aos-delay="250" className=" text-[18px]" href="#howtoplay" setActive={setActive} active={active} item="วิธีการเล่น" />
